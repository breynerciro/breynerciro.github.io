export const ui = {
  es: {
    ...
    'education.degree': 'Formación Académica',
    'education.certs': 'Certificaciones',
    'education.pending': 'Titulación en trámite',

    // Blog
    'blog.title': 'Blog',
    'blog.readMore': 'Leer más',
    'blog.backToBlog': '← Volver al blog',
    'blog.noPosts': 'Próximamente publicaremos artículos.',
    ...
    'contact.locationValue': 'Bogotá, D.C., Colombia',
    ...
    '404.description': 'Lo sentimos, la página que buscas no existe o fue movida.',
  ...
  en: {
    ...
    'education.pending': 'Degree in progress',

    // Blog
    'blog.title': 'Blog',
    'blog.readMore': 'Read more',
    'blog.backToBlog': '← Back to blog',
    'blog.noPosts': 'Articles coming soon.',
    ...
    '404.description': "Sorry, the page you're looking for doesn't exist or was moved.",
  ...
  pt: {
    ...
    'education.degree': 'Formação Acadêmica',
    'education.certs': 'Certificações',
    'education.pending': 'Diploma em andamento',

    // Blog
    'blog.title': 'Blog',
    'blog.readMore': 'Ler mais',
    'blog.backToBlog': '← Voltar ao blog',
    'blog.noPosts': 'Artigos em breve.',
    ...
    'contact.locationValue': 'Bogotá, D.C., Colômbia',
    ...
    '404.description': 'Desculpe, a página que você procura não existe ou foi movida.',
...
export type Translations = Record<UIKeys, string>;
